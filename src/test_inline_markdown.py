...
class test_inline_markdown(unittest.TestCase):
    ...
    def test_text_to_textnodes_no_images(self):
        text = "This is **text** with an _italic_ word and a `code block` and an [link](https://boot.dev)"
        self.assertEqual(
            text_to_textnodes(text),
            [
                TextNode("This is ", TextType.TEXT),
    ...
    def test_text_to_textnodes_no_code_and_italic(self):
        text = "This is **text** with an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg) and a [link](https://boot.dev)"
        self.assertEqual(
            text_to_textnodes(text),
            [
                TextNode("This is ", TextType.TEXT),
